...
import { PanelLeftIcon, LogOut } from "lucide-react";
...
// ─── Custom App Sidebar ───────────────────────────────────────────────────────
// This overrides the base `Sidebar` export with a self-contained navigation
// sidebar that accepts `items`, `logo`, and `title` props. It is self-contained
// and needs no SidebarProvider wrapper from the page.
  ...
  return (
    <aside className="w-64 min-h-screen bg-sidebar border-r border-sidebar-border flex flex-col shrink-0">
      ...
      <div className="flex items-center gap-3 px-6 py-5 border-b border-sidebar-border">
        ...
        <span className="font-semibold text-sidebar-foreground truncate">{title}</span>
      </div>
